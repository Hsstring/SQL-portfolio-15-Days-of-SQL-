-- Challenge 1
-- Topic : string functions: LENGTH,LOWER,UPPER
-- Database: GreenCycles
/*
In the email system there was a problem with names 
where either the first name or the last name is more than 10 characters long.
...
LOWER(email) AS email FROM customer
